...
// Tell Edgent which board we are on — sets button/LED pins in Settings.h
#define USE_ESP32C3_DEV_MODULE

#define BLYNK_TEMPLATE_ID   "TMPL6Ho-4zn87"
#define BLYNK_TEMPLATE_NAME "Home SG Watering"
...
// ------------------------------------------------------------------ //
static const uint8_t RELAY_GPIO[2] = {6, 7};
...
void setup() {
  ...
  // the factory-reset button (GPIO9 held 5 s).
  BlynkEdgent.begin();
}
